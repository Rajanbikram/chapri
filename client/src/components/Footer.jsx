      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 32, marginBottom: 40 }}>
          ...
          {[
            ...
            <div key={col.title}>
              <h4 style={{ color: "#fff", fontSize: ".88rem", fontWeight: 700, marginBottom: 14, letterSpacing: ".05em" }}>{col.title}</h4>
              <ul style={{ listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: 10 }}>
                {col.links.map(link => (
                  <li key={link}>
                    <a href="#" style={{ color: "#9ca3af", fontSize: ".83rem", textDecoration: "none", transition: "color .2s" }}
