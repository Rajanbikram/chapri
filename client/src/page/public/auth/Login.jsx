    ...
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:"#e8edf5", fontFamily:"'Segoe UI', Arial, sans-serif" }}>
      <div style={{ display:"flex", width:900, maxWidth:"98vw", minHeight:580, borderRadius:18, overflow:"hidden", boxShadow:"0 20px 60px rgba(0,0,0,.22)" }}>
        ...
        <div style={{ position:"relative", width:"44%", flexShrink:0, display:"flex", flexDirection:"column", justifyContent:"flex-end", padding:36, color:"#fff", overflow:"hidden" }}>
          <div style={{ position:"absolute", inset:0, backgroundImage:"url('https://images.unsplash.com/photo-1464037866556-6812c9d1c72e?w=800&q=80')", backgroundSize:"cover", backgroundPosition:"center", filter:"brightness(.7)" }} />
        ...
        {/* RIGHT */}
        <div style={{ flex:1, background:"#fff", padding:"44px 44px 36px", display:"flex", flexDirection:"column", justifyContent:"center" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading} style={{ width:"100%", padding:13, background: loading ? "#93b4f8" : "#1d6af4", color:"#fff", border:"none", borderRadius:9, fontSize:".97rem", fontWeight:700, cursor: loading ? "not-allowed" : "pointer" }}>
